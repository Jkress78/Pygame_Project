...
class CrescentSprite(pygame.sprite.Sprite):
    # -- Attributes
    ...
    def __init__(self):
        ...
        image = sprite_sheet.get_image(1, 0, 23, 23)
        self.moving_frames.append(image)
        image = sprite_sheet.get_image(27, 0, 23, 23)
        self.moving_frames.append(image)
        image = sprite_sheet.get_image(1, 25, 23, 23)
        self.moving_frames.append(image)
        image = sprite_sheet.get_image(27, 25, 23, 23)
        self.moving_frames.append(image)
