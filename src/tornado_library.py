...
class TornadoSprite(pygame.sprite.Sprite):
    # -- Attributes
    ...
    def __init__(self):
        ...
        image = sprite_sheet.get_image(1, 1, 21, 18)
        self.moving_frames.append(image)
        image = sprite_sheet.get_image(25, 1, 18, 21)
        self.moving_frames.append(image)
        image = sprite_sheet.get_image(1, 26, 21, 18)
        self.moving_frames.append(image)
        image = sprite_sheet.get_image(26, 24, 18, 21)
        self.moving_frames.append(image)
